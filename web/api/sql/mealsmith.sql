...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Már 26. 15:08
...
(5, 1, 'Chicken adobo 4', 'aaa', 'aa', 100, 1, 'chicken;500 mg|zöldség;400 mg|ketchup;1 kg', '2023-02-08 12:40:34', 14),
...
(40, 7, 'ketchup', 's\nd\nd\nf', 'as', 23, 12, 'ketchup;1kg|', '2023-03-13 13:50:32', 99999997),
...
(7, 'petyerka', 'szabopeter@turr.hu', '069313aeea17a7d95ecc3399e174bd0bb18e00eb', 'óbazS retéP', '-', 99999999, '2023-03-01 11:34:50', '2023-03-26 15:03:32', 1, NULL),
...
ALTER TABLE `follows`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`,`kovetett_user_id`);
